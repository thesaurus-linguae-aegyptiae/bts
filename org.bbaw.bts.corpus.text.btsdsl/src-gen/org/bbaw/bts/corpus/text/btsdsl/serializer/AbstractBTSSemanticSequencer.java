...
public abstract class AbstractBTSSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == BtsmodelPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case BtsmodelPackage.BTS_TRANSLATION:
				if(context == grammarAccess.getBTSTranslationRule()) {
					sequence_BTSTranslation(context, (BTSTranslation) semanticObject); 
					return; 
				}
				else break;
			case BtsmodelPackage.BTS_TRANSLATIONS:
				if(context == grammarAccess.getBTSTranslationsRule()) {
					sequence_BTSTranslations(context, (BTSTranslations) semanticObject); 
					return; 
				}
				else break;
	...
	/**
	 * Constraint:
	 *     (value=EString? type=EString? lang=EString?)
	 */
	protected void sequence_BTSTranslation(EObject context, BTSTranslation semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     ((translations+=BTSTranslation translations+=BTSTranslation*)?)
	 */
	protected void sequence_BTSTranslations(EObject context, BTSTranslations semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
