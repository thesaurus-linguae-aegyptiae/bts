...
entryRuleBTSTranslations returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getBTSTranslationsRule()); }
	 iv_ruleBTSTranslations=ruleBTSTranslations 
	 { $current=$iv_ruleBTSTranslations.current; } 
	 EOF 
;

// Rule BTSTranslations
ruleBTSTranslations returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleBTSTranslation returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getBTSTranslationRule()); }
	 iv_ruleBTSTranslation=ruleBTSTranslation 
	 { $current=$iv_ruleBTSTranslation.current; } 
	 EOF 
;

// Rule BTSTranslation
ruleBTSTranslation returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
