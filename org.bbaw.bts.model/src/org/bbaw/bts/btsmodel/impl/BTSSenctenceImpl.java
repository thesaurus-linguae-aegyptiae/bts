 ...
 * <ul>
 *   <li>{@link org.bbaw.bts.btsmodel.impl.BTSSenctenceImpl#getSentenceItems <em>Sentence Items</em>}</li>
 *   <li>{@link org.bbaw.bts.btsmodel.impl.BTSSenctenceImpl#getTranslation <em>Translation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BTSSenctenceImpl extends BTSReferencableItemImpl implements BTSSenctence {
	...
	protected EClass eStaticClass() {
		return BtsmodelPackage.Literals.BTS_SENCTENCE;
	}
	...
	public void setTranslation(BTSTranslations newTranslation) {
		if (newTranslation != translation)
		{
			...
			if (newTranslation != null)
				msgs = ((InternalEObject)newTranslation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BtsmodelPackage.BTS_SENCTENCE__TRANSLATION, null, msgs);
			msgs = basicSetTranslation(newTranslation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BtsmodelPackage.BTS_SENCTENCE__TRANSLATION, newTranslation, newTranslation));
	}
