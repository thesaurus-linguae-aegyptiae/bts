 ...
 * <ul>
 *   <li>{@link org.bbaw.bts.corpus.text.egy.dsl.egyBts.impl.TextContentImpl#getItems <em>Items</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TextContentImpl extends MinimalEObjectImpl.Container implements TextContent
{
  ...
  {
    return EgyBtsPackage.Literals.TEXT_CONTENT;
  }
  ...
  public EList<TextItem> getItems()
  {
    if (items == null)
    {
      items = new EObjectContainmentEList<TextItem>(TextItem.class, this, EgyBtsPackage.TEXT_CONTENT__ITEMS);
    }
    return items;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EgyBtsPackage.TEXT_CONTENT__ITEMS:
