 ...
 * <ul>
 *   <li>{@link org.bbaw.bts.corpus.text.egy.dsl.egyBts.impl.EmendationImpl#getWChar <em>WChar</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EmendationImpl extends BracketsImpl implements Emendation
{
  ...
  {
    return EgyBtsPackage.Literals.EMENDATION;
  }
  ...
  public EList<NoEmendation> getWChar()
  {
    if (wChar == null)
    {
      wChar = new EObjectContainmentEList<NoEmendation>(NoEmendation.class, this, EgyBtsPackage.EMENDATION__WCHAR);
    }
    return wChar;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EgyBtsPackage.EMENDATION__WCHAR:
