 ...
 * <ul>
 *   <li>{@link org.bbaw.bts.corpus.text.egy.dsl.egyBts.impl.DeletionImpl#getWChar <em>WChar</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DeletionImpl extends BracketsImpl implements Deletion
{
  ...
  {
    return EgyBtsPackage.Literals.DELETION;
  }
  ...
  public EList<NoDeletion> getWChar()
  {
    if (wChar == null)
    {
      wChar = new EObjectContainmentEList<NoDeletion>(NoDeletion.class, this, EgyBtsPackage.DELETION__WCHAR);
    }
    return wChar;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EgyBtsPackage.DELETION__WCHAR:
