 ...
 * <ul>
 *   <li>{@link org.bbaw.bts.corpus.text.egy.dsl.egyBts.impl.SentenceImpl#getItems <em>Items</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SentenceImpl extends TextItemImpl implements Sentence
{
  ...
  {
    return EgyBtsPackage.Literals.SENTENCE;
  }
  ...
  public EList<SentenceItem> getItems()
  {
    if (items == null)
    {
      items = new EObjectContainmentEList<SentenceItem>(SentenceItem.class, this, EgyBtsPackage.SENTENCE__ITEMS);
    }
    return items;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EgyBtsPackage.SENTENCE__ITEMS:
