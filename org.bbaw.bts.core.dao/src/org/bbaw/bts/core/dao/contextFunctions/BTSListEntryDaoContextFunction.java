...
public class BTSListEntryDaoContextFunction extends ContextFunction
{
	@Inject
	...
	public Object compute(IEclipseContext context)
	{
		...
		try
		{
			dao = loadDaoFactory(context).createDao(BTSListEntryDao.class, context);
		...
		context.set(BTSListEntryDao.class, dao);
	...
	private DAOFactory loadDaoFactory(IEclipseContext context) throws CoreException
	{
		...
		throw new BTSDBException("No DaoFactory found for BTSListEntryDao and factory name: " + daoFactoryName);
