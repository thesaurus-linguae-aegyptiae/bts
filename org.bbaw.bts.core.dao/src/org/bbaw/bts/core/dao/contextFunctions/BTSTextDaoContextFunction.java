...
public class BTSTextDaoContextFunction extends ContextFunction
{
	@Inject
	...
	public Object compute(IEclipseContext context)
	{
		...
		try
		{
			dao = loadDaoFactory(context).createDao(BTSTextDao.class, context);
	...
	private DAOFactory loadDaoFactory(IEclipseContext context) throws CoreException
	{
		...
		throw new BTSDBException("No DaoFactory found for BTSTextDao and factory name: " + daoFactoryName);
