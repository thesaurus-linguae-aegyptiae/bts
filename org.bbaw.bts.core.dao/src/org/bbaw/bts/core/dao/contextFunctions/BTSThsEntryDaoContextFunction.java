...
public class BTSThsEntryDaoContextFunction extends ContextFunction
{
	@Inject
	...
	public Object compute(IEclipseContext context)
	{
		...
		try
		{
			dao = loadDaoFactory(context).createDao(BTSThsEntryDao.class, context);
	...
	private DAOFactory loadDaoFactory(IEclipseContext context) throws CoreException
	{
		...
		throw new BTSDBException("No DaoFactory found for BTSThsEntryDao and factory name: " + daoFactoryName);
