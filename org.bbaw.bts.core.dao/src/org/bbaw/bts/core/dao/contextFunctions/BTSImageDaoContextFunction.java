...
public class BTSImageDaoContextFunction extends ContextFunction
{
	@Inject
	...
	public Object compute(IEclipseContext context)
	{
		...
		try
		{
			dao = loadDaoFactory(context).createDao(BTSImageDao.class, context);
	...
	private DAOFactory loadDaoFactory(IEclipseContext context) throws CoreException
	{
		...
		throw new BTSDBException("No DaoFactory found for BTSImageDao and factory name: " + daoFactoryName);
