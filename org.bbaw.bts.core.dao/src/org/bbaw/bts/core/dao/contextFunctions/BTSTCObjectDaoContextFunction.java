...
public class BTSTCObjectDaoContextFunction extends ContextFunction
{
	@Inject
	...
	public Object compute(IEclipseContext context)
	{
		...
		try
		{
			dao = loadDaoFactory(context).createDao(BTSTCObjectDao.class, context);
	...
	private DAOFactory loadDaoFactory(IEclipseContext context) throws CoreException
	{
		...
		throw new BTSDBException("No DaoFactory found for BTSTCObjectDao and factory name: " + daoFactoryName);
