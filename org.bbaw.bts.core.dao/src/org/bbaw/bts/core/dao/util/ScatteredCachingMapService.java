...
public class ScatteredCachingMapService implements Map<URI, Resource>
{
	...
	public boolean containsKey(Object key)
	{
		...
		{
			if (part.getObject() != null && part.getObject() instanceof ScatteredCachingPart)
			{
				List<Map> maps = ((ScatteredCachingPart) part.getObject()).getScatteredCashMaps();
				for (Map map : maps)
				{
	...
	{
		//FIXME dies setzt ein active window voraus - nicht gegeben, wenn parts im dialog geöffnet werden.
		if (partService == null)
		{
			return null;
		}
