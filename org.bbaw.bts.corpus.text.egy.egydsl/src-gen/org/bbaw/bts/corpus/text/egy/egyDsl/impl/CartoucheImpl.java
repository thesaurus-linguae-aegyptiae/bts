 ...
 * <ul>
 *   <li>{@link org.bbaw.bts.corpus.text.egy.egyDsl.impl.CartoucheImpl#getWChar <em>WChar</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CartoucheImpl extends BracketsImpl implements Cartouche
{
  ...
  public EList<NoCartouche> getWChar()
  {
    if (wChar == null)
    {
      wChar = new EObjectContainmentEList<NoCartouche>(NoCartouche.class, this, EgyDslPackage.CARTOUCHE__WCHAR);
    }
    return wChar;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EgyDslPackage.CARTOUCHE__WCHAR:
