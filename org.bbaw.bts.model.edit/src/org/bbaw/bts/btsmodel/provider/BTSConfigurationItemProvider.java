 ...
 * @generated
 */
public class BTSConfigurationItemProvider
	...
	protected void addNamePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BTSConfiguration_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BTSConfiguration_name_feature", "_UI_BTSConfiguration_type"),
				 BtsmodelPackage.Literals.BTS_CONFIGURATION__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_BTSConfiguration_type") :
			getString("_UI_BTSConfiguration_type") + " " + label;
	}
