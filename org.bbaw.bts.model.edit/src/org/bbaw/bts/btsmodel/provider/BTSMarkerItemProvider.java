...
/**
 * This is the item provider adapter for a {@link org.bbaw.bts.btsmodel.BTSMarker} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		IItemFontProvider
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BtsmodelPackage.Literals.BTS_MARKER__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object)
	{
		...
		return label == null || label.length() == 0 ?
			getString("_UI_BTSMarker_type") :
			getString("_UI_BTSMarker_type") + " " + label;
	}
