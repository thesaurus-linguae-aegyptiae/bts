...
/**
 * This is the item provider adapter for a {@link org.bbaw.bts.btsmodel.BTSListEntry} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BTSListEntryItemProvider extends BTSCorpusObjectItemProvider implements IEditingDomainItemProvider,
		...
		ITableItemLabelProvider, ITableItemColorProvider, ITableItemFontProvider, IItemColorProvider, IItemFontProvider
{
	 ...
	 * @generated
	 */
	public BTSListEntryItemProvider(AdapterFactory adapterFactory)
	{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BTSListEntry_ignore_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BTSListEntry_ignore_feature", "_UI_BTSListEntry_type"),
				 BtsmodelPackage.Literals.BTS_LIST_ENTRY__IGNORE,
				 true,
				 false,
				 false,
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BTSListEntry"));
	}
	...
	{
		String label = ((BTSListEntry) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_BTSListEntry_type") : label;
	}
