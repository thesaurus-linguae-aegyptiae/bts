...
/**
 * This is the item provider adapter for a {@link org.bbaw.bts.btsmodel.BTSReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BTSReferenceItemProvider
	 ...
	 * @generated
	 */
	public BTSReferenceItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BTSReference_objectId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BTSReference_objectId_feature", "_UI_BTSReference_type"),
				 BtsmodelPackage.Literals.BTS_REFERENCE__OBJECT_ID,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((BTSReference)object).getObjectId();
		return label == null || label.length() == 0 ?
			getString("_UI_BTSReference_type") :
			getString("_UI_BTSReference_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BtsmodelPackage.Literals.BTS_REFERENCE__PARTS,
