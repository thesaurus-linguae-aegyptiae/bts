...
public class BTSEgySourceViewerConfiguration extends SourceViewerConfiguration
{
	...
	{
		IToken comment = new Token(new TextAttribute(new Color(Display.getCurrent(), 0, 0, 170)));
		IToken element = new Token(new TextAttribute(new Color(Display.getCurrent(), 220, 80, 100)));
		...
		IWordDetector wordDetector2 = new IWordDetector()
		{
		...
		//		return new IRule[] { new SingleLineRule("<", ">", element, '\\'),
		//				new SingleLineRule("\"", "\"", attribute, '\\'), new SingleLineRule("<!--", "-->", comment, '\\'),
		//				new WordPatternRule(startSentenceDetector, ">", ">", startSentence, '\\') };
		//		return new IRule[] { new WordPatternRule(startSentenceDetector, ">", ">", startSentence, '\\'),
		//				new WordPatternRule(endSentenceDetector, "<", "<", startSentence, '\\'),
		//				//				new WordPatternRule(wordDetector, " ", " ", word, '\\'),
		//				new WordPatternRule(nameDetector, " ", " ", word), new WhitespaceRule(new IWhitespaceDetector()
		//				{
		//
		//					@Override
		...
		//					}
		//				})
		//		//				new BTSTextTokenRule(wordDetector2, "W", "w", word) 
		//		};
