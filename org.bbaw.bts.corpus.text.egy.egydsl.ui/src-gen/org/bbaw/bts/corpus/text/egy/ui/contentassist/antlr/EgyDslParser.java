		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDisputableDestroyedVersMarkerAccess().getGroup(), "rule__DisputableDestroyedVersMarker__Group__0");
					put(grammarAccess.getDisputableDeletedVersMarkerAccess().getGroup(), "rule__DisputableDeletedVersMarker__Group__0");
					put(grammarAccess.getDeletedVersMarkerAccess().getGroup(), "rule__DeletedVersMarker__Group__0");
					put(grammarAccess.getDeletedDisputableVersMarkerAccess().getGroup(), "rule__DeletedDisputableVersMarker__Group__0");
					put(grammarAccess.getDeletedDestroyedVersMarkerAccess().getGroup(), "rule__DeletedDestroyedVersMarker__Group__0");
					...
					put(grammarAccess.getDestroyedDisputableVersFrontierMarkerAccess().getGroup(), "rule__DestroyedDisputableVersFrontierMarker__Group__0");
					put(grammarAccess.getDestroyedDeletedVersMarkerAccess().getGroup(), "rule__DestroyedDeletedVersMarker__Group__0");
					put(grammarAccess.getPartialDestroyedVersMarkerAccess().getGroup(), "rule__PartialDestroyedVersMarker__Group__0");
					put(grammarAccess.getPartialDestroyedDisputableVersMarkerAccess().getGroup(), "rule__PartialDestroyedDisputableVersMarker__Group__0");
					put(grammarAccess.getPartialDestroyedDeletedVersMarkerAccess().getGroup(), "rule__PartialDestroyedDeletedVersMarker__Group__0");
					put(grammarAccess.getMissingVersMarkerAccess().getGroup(), "rule__MissingVersMarker__Group__0");
					put(grammarAccess.getMissingDisputableVersMarkerAccess().getGroup(), "rule__MissingDisputableVersMarker__Group__0");
