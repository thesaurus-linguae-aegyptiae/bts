		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDualEndingAccess().getCharsAlternatives_0(), "rule__DualEnding__CharsAlternatives_0");
					put(grammarAccess.getPluralEndingAccess().getCharsAlternatives_0(), "rule__PluralEnding__CharsAlternatives_0");
					...
					put(grammarAccess.getEndingAccess().getCharsAssignment(), "rule__Ending__CharsAssignment");
					put(grammarAccess.getDualEndingAccess().getCharsAssignment(), "rule__DualEnding__CharsAssignment");
					put(grammarAccess.getPluralEndingAccess().getCharsAssignment(), "rule__PluralEnding__CharsAssignment");
