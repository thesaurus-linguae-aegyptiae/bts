		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getWordEndingAccess().getAlternatives(), "rule__WordEnding__Alternatives");
					...
					put(grammarAccess.getWordPartAccess().getGroup_1(), "rule__WordPart__Group_1__0");
					put(grammarAccess.getDualEndingAccess().getGroup(), "rule__DualEnding__Group__0");
					put(grammarAccess.getPluralEndingAccess().getGroup(), "rule__PluralEnding__Group__0");
					put(grammarAccess.getInterfixFlexionEdingAccess().getGroup(), "rule__InterfixFlexionEding__Group__0");
					put(grammarAccess.getInterfixLexicalEndingAccess().getGroup(), "rule__InterfixLexicalEnding__Group__0");
					...
					put(grammarAccess.getSentenceAccess().getItemsAssignment_1_1_2(), "rule__Sentence__ItemsAssignment_1_1_2");
					...
					put(grammarAccess.getWordAccess().getWCharAssignment_1_0(), "rule__Word__WCharAssignment_1_0");
					put(grammarAccess.getWordAccess().getWCharAssignment_1_1_1(), "rule__Word__WCharAssignment_1_1_1");
					put(grammarAccess.getWordPartAccess().getWCharAssignment_1_0(), "rule__WordPart__WCharAssignment_1_0");
					put(grammarAccess.getWordPartAccess().getWCharAssignment_1_1(), "rule__WordPart__WCharAssignment_1_1");
					put(grammarAccess.getWordPartAccess().getWCharAssignment_1_2(), "rule__WordPart__WCharAssignment_1_2");
					put(grammarAccess.getWordPartAccess().getWCharAssignment_1_3(), "rule__WordPart__WCharAssignment_1_3");
					put(grammarAccess.getDualEndingAccess().getInterfixAssignment_0(), "rule__DualEnding__InterfixAssignment_0");
					put(grammarAccess.getDualEndingAccess().getCharsAssignment_1(), "rule__DualEnding__CharsAssignment_1");
					put(grammarAccess.getDualCharsAccess().getNameAssignment(), "rule__DualChars__NameAssignment");
					put(grammarAccess.getPluralCharsAccess().getNameAssignment(), "rule__PluralChars__NameAssignment");
					put(grammarAccess.getPluralEndingAccess().getInterfixAssignment_0(), "rule__PluralEnding__InterfixAssignment_0");
					put(grammarAccess.getPluralEndingAccess().getCharsAssignment_1(), "rule__PluralEnding__CharsAssignment_1");
					put(grammarAccess.getInterfixFlexionEdingAccess().getInterfixAssignment_0(), "rule__InterfixFlexionEding__InterfixAssignment_0");
					put(grammarAccess.getInterfixFlexionEdingAccess().getCharsAssignment_1(), "rule__InterfixFlexionEding__CharsAssignment_1");
					put(grammarAccess.getInterfixLexicalEndingAccess().getInterfixAssignment_0(), "rule__InterfixLexicalEnding__InterfixAssignment_0");
					put(grammarAccess.getInterfixLexicalEndingAccess().getCharsAssignment_1(), "rule__InterfixLexicalEnding__CharsAssignment_1");
					put(grammarAccess.getCharsAccess().getNameAssignment(), "rule__Chars__NameAssignment");
					put(grammarAccess.getSuffixCharsAccess().getNameAssignment(), "rule__SuffixChars__NameAssignment");
