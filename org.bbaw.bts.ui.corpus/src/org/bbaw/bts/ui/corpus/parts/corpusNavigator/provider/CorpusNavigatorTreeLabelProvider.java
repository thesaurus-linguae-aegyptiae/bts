...
//
// StyledString styledString = new StyledString(p.getName() != null ?
// p.getName() : "*noname*", null);
...
// {
// if (element instanceof BTSCorpusObject && !((BTSCorpusObject)
// element).getRelations().isEmpty())
// {
...
// if (o.getPassport() != null && o.getName() != null &&
