...
//			child.set(Composite.class, composite_CorpusNavigator);
			...
			SearchViewer searchViewer = makeSearchViewer(composite_CorpusNavigator, relationConfig, "CorpusNavigator");
		}
...
//					BTSUIConstants.SELECTION_TYPE_SECONDARY);
			...
			SearchViewer searchViewer = makeSearchViewer(composite_wlistNavigator, relationConfig, "LemmaNavigator");
...
//					ThsNavigator.class, child_ths);
			...
			SearchViewer searchViewer = makeSearchViewer(composite_thsNavigator, relationConfig, "ThsNavigator");
	...
	private List<SearchViewerFactory> loadSearchViewerFactory(String viewerName) {
		...
		List<SearchViewerFactory> searchViewerFactories = new Vector<SearchViewerFactory>(config.length);
