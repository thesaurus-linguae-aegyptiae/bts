...
public class BtsCorpusModelPackageImpl extends EPackageImpl implements BtsCorpusModelPackage {
	...
	public void initializePackageContents() {
		...
		btsTextItemsEClass.getESuperTypes().add(theBtsmodelPackage.getBTSIdentifiableItem());
		...
		btsSentenceItemEClass.getESuperTypes().add(theBtsmodelPackage.getBTSIdentifiableItem());
		...
		btsLemmaCaseEClass.getESuperTypes().add(theBtsmodelPackage.getBTSIdentifiableItem());
