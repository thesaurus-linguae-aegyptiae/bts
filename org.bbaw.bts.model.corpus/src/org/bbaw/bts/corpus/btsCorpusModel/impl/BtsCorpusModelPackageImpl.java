...
public class BtsCorpusModelPackageImpl extends EPackageImpl implements BtsCorpusModelPackage {
	...
	public void initializePackageContents() {
		...
		btsTextItemsEClass.getESuperTypes().add(theBtsmodelPackage.getBTSReferencableItem());
		btsGraphicEClass.getESuperTypes().add(theBtsmodelPackage.getBTSIdentifiableItem());
		btsSenctenceEClass.getESuperTypes().add(theBtsmodelPackage.getBTSReferencableItem());
		btsSenctenceEClass.getESuperTypes().add(this.getBTSTextItems());
		btsMarkerEClass.getESuperTypes().add(theBtsmodelPackage.getBTSReferencableItem());
		...
		btsSentenceItemEClass.getESuperTypes().add(theBtsmodelPackage.getBTSReferencableItem());
		btsAmbivalenceEClass.getESuperTypes().add(theBtsmodelPackage.getBTSReferencableItem());
		...
		btsLemmaCaseEClass.getESuperTypes().add(theBtsmodelPackage.getBTSReferencableItem());
